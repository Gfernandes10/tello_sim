###########################################################################
## Makefile generated for component 'NumLinearModel'. 
## 
## Makefile     : NumLinearModel.mk
## Generated on : Fri May 30 20:21:40 2025
## Final product: .\NumLinearModel_rtwlib.lib
...
COMPILER_COMMAND_FILE     = NumLinearModel_comp.rsp
CMD_FILE                  = NumLinearModel.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = /std:c++20
NODEBUG                   = 1
MODELLIB                  = NumLinearModel_rtwlib.lib
...
PRODUCT = .\NumLinearModel_rtwlib.lib
...
DEFINES_STANDARD = -DMODEL=NumLinearModel -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)\slprj\grt\NumLinearModel\NumLinearModel.cpp
...
{$(START_DIR)\slprj\grt\NumLinearModel}.c.obj:
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\slprj\grt\NumLinearModel}.cpp.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\slprj\grt\NumLinearModel}.cc.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\slprj\grt\NumLinearModel}.cxx.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
NumLinearModel.obj : "$(START_DIR)\slprj\grt\NumLinearModel\NumLinearModel.cpp"
	$(CPP) $(CPPFLAGS) -Fo"$@" "$(START_DIR)\slprj\grt\NumLinearModel\NumLinearModel.cpp"
