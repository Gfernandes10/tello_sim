###########################################################################
## Makefile generated for component 'NoLinearModel'. 
## 
## Makefile     : NoLinearModel.mk
## Generated on : Wed Jun 25 20:47:52 2025
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\NoLinearModel.exe
...
COMPILER_COMMAND_FILE     = NoLinearModel_comp.rsp
CMD_FILE                  = NoLinearModel.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
NODEBUG                   = 1
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\NoLinearModel.exe
...
DEFINES_STANDARD = -DMODEL=NoLinearModel -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)\NoLinearModel_ert_rtw\NoLinearModel.cpp

MAIN_SRC = $(START_DIR)\NoLinearModel_ert_rtw\ert_main.cpp
...
{$(START_DIR)\NoLinearModel_ert_rtw}.c.obj:
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\NoLinearModel_ert_rtw}.cpp.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\NoLinearModel_ert_rtw}.cc.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\NoLinearModel_ert_rtw}.cxx.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
NoLinearModel.obj : "$(START_DIR)\NoLinearModel_ert_rtw\NoLinearModel.cpp"
	$(CPP) $(CPPFLAGS) -Fo"$@" "$(START_DIR)\NoLinearModel_ert_rtw\NoLinearModel.cpp"


ert_main.obj : "$(START_DIR)\NoLinearModel_ert_rtw\ert_main.cpp"
	$(CPP) $(CPPFLAGS) -Fo"$@" "$(START_DIR)\NoLinearModel_ert_rtw\ert_main.cpp"
